...
| 03 | [`03-customer-workspace.md`](03-customer-workspace.md) | Editing `CustomerRevenueWorkspace` or its four permanent layers |
| 04 | [`04-lifecycle-tabs.md`](04-lifecycle-tabs.md) | Editing any per-tab content (Customer / Quote / Contract / Invoicing / Payment / RevRec) |
| 05 | [`05-index-pages.md`](05-index-pages.md) | Editing a module index page or the grouped/list primitives |
...
| `ingestion-approvals.mdc` | ingest/approval pages, `IngestContext`, `ingest-data.ts`, contracts/approvals components | docs 09, 06, 08 |
| `mock-data.mdc` | `src/data/**`, `src/context/**` | doc 08 |
| `shell-and-layout.mdc` | `src/components/layout/**`, `App.tsx`, `main.tsx` | docs 01, 02, 06 |
| `workbench-home.mdc` | `src/pages/workbench/**`, `src/components/getting-started/**` | docs 10, 02 |
...
3. **When you want to steer context explicitly:** reference a doc directly in your message, e.g. "Polish the Quote tab insight rail — see `@docs/04-lifecycle-tabs.md` and `@docs/02-design-system.md`."
