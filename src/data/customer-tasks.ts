...
export const customerTasks: CustomerTask[] = [
  ...
  // Zenith Analytics INC tasks (Echo Corp parity)
  {
    id: "TASK-040",
    customerId: "cust_zenith_analytics_inc",
    title: "Review renewal quote before expiry",
    description: "QT-2026-0050 expires in 5 days. Customer is waiting for final terms.",
    type: "quote-follow-up",
    priority: "critical",
    status: "open",
    assignee: "Jordan Kim",
    dueDate: "2026-05-10",
    createdAt: "2026-05-01",
    relatedTo: { entityType: "quote", entityId: "QT-2026-0050", label: "QT-2026-0050" },
    action: { stage: "quote" },
  },
  {
    id: "TASK-041",
    customerId: "cust_zenith_analytics_inc",
    title: "Review and send INV-2026-0051 for approval",
    description: "Invoice held due to missing PO number. Follow up with customer.",
    type: "invoice-review",
    priority: "high",
    status: "open",
    ...
    dueDate: "2026-05-08",
    createdAt: "2026-04-28",
    relatedTo: { entityType: "invoice", entityId: "INV-2026-0051", label: "INV-2026-0051" },
    action: { stage: "invoicing" },
  },
  {
    id: "TASK-042",
    customerId: "cust_zenith_analytics_inc",
    title: "Collect on overdue INV-2026-0050",
    description: "Invoice is 45+ days overdue. Customer promised payment by end of week.",
    type: "collections",
    priority: "high",
    status: "in_progress",
    ...
    dueDate: "2026-05-05",
    createdAt: "2026-04-15",
    relatedTo: { entityType: "invoice", entityId: "INV-2026-0050", label: "INV-2026-0050" },
    action: { stage: "payment" },
  },
  {
    id: "TASK-043",
    customerId: "cust_zenith_analytics_inc",
    title: "Ingest renewal contract CON-2026-0193",
    description: "New contract uploaded to queue. Needs field mapping and first invoice review.",
    type: "contract-ingestion",
    priority: "critical",
    status: "open",
    ...
    dueDate: "2026-05-06",
    createdAt: "2026-05-02",
    relatedTo: { entityType: "contract", entityId: "CON-2026-0193", label: "CON-2026-0193" },
    action: { stage: "contract" },
  },
];
