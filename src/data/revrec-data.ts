...
export const revenueArrangements: RevenueArrangement[] = [
  ...
  },
  {
    ...
    lastRecalculated: "2026-03-31",
    closeStatus: "1 blocker",
    recognizedToDate: 248400,
    deferred: 164400,
    totalArrangementValue: 412800,
    obligations: [
      {
        product: "Apex Analytics Pro (150 seats)",
        obligationType: "over-time",
        allocationBasis: "SSP – relative standalone selling price",
        allocatedAmount: 332800,
        recognizedToDate: 220000,
        deferredRemaining: 112800,
        method: "Straight-line over 24-month term",
      },
      {
        product: "Premium Support",
        ...
        allocationBasis: "SSP – standalone price",
        allocatedAmount: 80000,
        recognizedToDate: 28400,
        deferredRemaining: 51600,
        method: "Straight-line monthly over contract term",
      },
    ],
    schedule: [
      { period: "2025-Q4", recognized: 45600, deferred: 43400, remaining: 69900, amended: false },
      { period: "2026-Q1", recognized: 56400, deferred: 32600, remaining: 13500, amended: true },
    ],
    closeBlockers: [
      {
        description: "Amendment AMD-ZEN-001 (seat expansion) pending schedule rerun.",
        severity: "warning",
        category: "Pending reallocation",
        resolved: false,
      },
    ...
    journalExports: [
      { id: "JE-ZEN-2026-Q1", period: "2026-Q1", status: "posted", erpReference: "ERP-JE-ZEN-20260115", exportDate: "2026-01-15", failReason: "" },
    ],
    adjustments: [],
    amendmentImpacts: [],
    invoiceImpacts: [
      { invoiceId: "INV-2026-0050", billedAmount: 5800, creditedAmount: 0, correction: "", accountingEntriesUpdated: false },
    ],
  },
  {
    id: "RA-2026-0002",
