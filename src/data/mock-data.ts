import {
  ...
  zenithAnalyticsIncContracts,
  zenithAnalyticsIncInvoices,
  zenithAnalyticsIncQuotes,
...
export const customers: Customer[] = [
  ...
  // Near-matches for new-deal customer link search (Zenith Analytics ingest demo)
  {
    id: "cust_zenith_digital_007",
    name: "Zenith Digital Group",
    commercialAccount: "Zenith Digital Group – APAC",
    billingLegalEntity: "Zenith Digital Group Pvt. Ltd.",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ae: "Jordan Kim",
    ...
    domain: "zenithdigital.io",
    industry: "Data Infrastructure",
    region: "India",
    crmAccountId: "001Dn000013xF9K",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-04-10T08:00:00Z",
    paymentMethod: "Wire",
    currency: "USD",
    taxRegion: "IN – Karnataka",
    poRequired: false,
    activeContractCount: 1,
    openQuoteCount: 0,
  },
  {
    id: "cust_zenith_cloud_008",
    name: "Zenith Cloud LLC",
    commercialAccount: "Zenith Cloud – Americas",
    billingLegalEntity: "Zenith Cloud LLC",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ae: "Marcus Lee",
    ...
    crmAccountId: "001Dn000014xG0L",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-04-12T14:20:00Z",
    paymentMethod: "ACH",
    currency: "USD",
    taxRegion: "US – Washington",
    poRequired: false,
    activeContractCount: 2,
    openQuoteCount: 1,
  },
  {
    id: "cust_zenith_labs_009",
    name: "Zenith Labs",
    commercialAccount: "Zenith Labs – EMEA",
    billingLegalEntity: "Zenith Labs GmbH",
    chargebeeEntity: "Chargebee EU – Germany",
    segment: "Enterprise",
    tier: "Tier 2",
    ae: "Sophia Brandt",
    ...
    arr: 210000,
    tcv: 420000,
    prepaidCreditBalance: 18000,
    prepaidCreditTotal: 40000,
    openAr: 0,
    nextRenewalDate: "2026-12-01",
    riskBadges: [],
    createdAt: "2024-09-20",
    domain: "zenithlabs.de",
    industry: "AI Research",
    region: "Germany",
    crmAccountId: "001Dn000015xH1M",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-03-22T09:30:00Z",
    paymentMethod: "Wire",
    currency: "EUR",
    taxRegion: "EU – Germany",
    poRequired: true,
