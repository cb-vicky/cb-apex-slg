...
export const customers: Customer[] = [
  ...
  {
    // Closest-match target for sample5 / QI-2026-0007 (suggestedCustomerId in queue-data).
    id: "cust_pioneer_004",
  ...
  // Near-duplicate Pioneer Systems records for sample5 match-first / customer-link demo.
  // Primary contact in the link modal = `csm` (else billingOwner, else ae) — see customer-link-display.ts.
  {
    id: "cust_pioneer_systems_v2",
    name: "Pioneer systems",
    commercialAccount: "Pioneer systems – Americas",
    billingLegalEntity: "Pioneer Systems Inc.",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ae: "Jordan Kim",
    ...
    industry: "AI Code Review",
    region: "North America",
    crmAccountId: "001Dn000011xD8A",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-03-28T11:00:00Z",
    paymentMethod: "ACH",
    currency: "USD",
    taxRegion: "US – Texas",
    poRequired: false,
  ...
  {
    id: "cust_pioneer_systems_typo",
    name: "Pinoeer Systems",
    commercialAccount: "Pinoeer Systems – Americas",
    billingLegalEntity: "Pioneer Systems Corp.",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ...
    domain: "pinoeersystems.com",
    industry: "AI Code Review",
    region: "North America",
    crmAccountId: "001Dn000011xD9B",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-02-14T08:30:00Z",
    paymentMethod: "Wire",
    currency: "USD",
    taxRegion: "US – California",
    poRequired: false,
  ...
  {
    id: "cust_pioneer_systems_singular",
    name: "Pioneer System",
    commercialAccount: "Pioneer System – Americas",
    billingLegalEntity: "Pioneer System Corp.",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ae: "Jordan Kim",
    ...
    domain: "pioneer-system.com",
    industry: "AI Code Review",
    region: "North America",
    crmAccountId: "001Dn000011xE1C",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-01-05T14:00:00Z",
    paymentMethod: "Card",
    currency: "USD",
    taxRegion: "US – Texas",
    poRequired: false,
  ...
  {
    id: "cust_pioneer_systems_plural",
    name: "Pioneers Systems",
    commercialAccount: "Pioneers Systems – Americas",
    billingLegalEntity: "Pioneers Systems LLC",
    chargebeeEntity: "Chargebee US – Acme Merchant",
    segment: "Mid-Market",
    tier: "Tier 2",
    ae: "Jordan Kim",
    csm: "Samira Patel",
    billingOwner: "Samira Patel",
    arr: 0,
    tcv: 186000,
    prepaidCreditBalance: 0,
    prepaidCreditTotal: 0,
    ...
    domain: "pioneers-systems.com",
    industry: "AI Code Review",
    region: "North America",
    crmAccountId: "001Dn000011xF2D",
    crmSyncStatus: "Synced",
    crmLastSyncedAt: "2026-03-10T09:15:00Z",
    paymentMethod: "ACH",
    currency: "USD",
    taxRegion: "US – Texas",
    poRequired: false,
...
export const contracts: Contract[] = [
  ...
  },
  {
    ...
    products: [
      { sku: "APEX-PLATFORM", name: "Apex Platform – Enterprise", type: "recurring", quantity: 400, unitPrice: 45, discountApplied: 18, minimumCommit: 240000, prepaidCredits: 0, overageRate: 0, billingCadence: "Annual upfront" },
      { sku: "APEX-AI-CREDITS", name: "AI Agent Credits – Prepaid Block", type: "one-time", quantity: 1, unitPrice: 120000, discountApplied: 0, minimumCommit: 0, prepaidCredits: 120000, overageRate: 0, billingCadence: "Prepaid" },
      { sku: "APEX-AI-OVERAGE", name: "AI Agent Credits – Overage", type: "usage", quantity: 0, unitPrice: 0.018, discountApplied: 0, minimumCommit: 0, prepaidCredits: 0, overageRate: 0.018, billingCadence: "Monthly arrears" },
      { sku: "APEX-SUPPORT", name: "Premium Support – 24/7", type: "recurring", quantity: 1, unitPrice: 2500, discountApplied: 0, minimumCommit: 0, prepaidCredits: 0, overageRate: 0, billingCadence: "Monthly" },
    ],
    enforcement: {
      sourceType: "Ingested PDF (linked to QT-2026-0042)",
    ...
    billingSchedule: [
      { date: "2026-05-01", amount: 261800, status: "Scheduled" },
    ],
    amendments: [],
    invoicesGenerated: 0,
    creditNotes: 0,
    ...
    comparisonToQuote: [],
    timeline: [
      { date: "2026-04-12", action: "Contract signed", actor: "Echo Corp", detail: "Signed by CFO Mira Patel via DocuSign" },
      { date: "2026-04-17", action: "Contract ingested from PDF", actor: "System", detail: "Extraction confidence: 97% · Linked to QT-2026-0042" },
      { date: "2026-05-01", action: "Contract activates", actor: "System", detail: "Billing and entitlements scheduled to enforce on start date" },
    ],
    paymentTerms: "Net 45",
    billingFrequency: "Annual upfront + monthly overage",
    coTermBehavior: "N/A",
